...
namespace StoreOrder.WebApplication.Data.Migrations
{
    ...
    [Migration("20200605142054_UserDetailsAddColumnGAvartar")]
    partial class UserDetailsAddColumnGAvartar
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StoreOrder.WebApplication.Data.Models.Account.UserDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("StoreOrder.WebApplication.Data.Models.Orders.Order", b =>
                {
                    ...
                    b.Property<string>("UserCookingId")
                        .HasColumnType("character varying(50)")
                        .HasMaxLength(50);
            ...
            modelBuilder.Entity("StoreOrder.WebApplication.Data.Models.Settings.Setting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<string>("SettingValueVarchar")
            ...
            modelBuilder.Entity("StoreOrder.WebApplication.Data.Orders.OrderDetail", b =>
                {
                    ...
                    b.Property<string[]>("OptionId_OptionValueIds")
                        .HasColumnName("OptionId_OptionValueIds")
                        .HasColumnType("text[]");
            ...
            modelBuilder.Entity("StoreOrder.WebApplication.Data.Models.Account.UserDetail", b =>
                {
                    b.HasOne("StoreOrder.WebApplication.Data.Models.Account.User", "User")
                        .WithOne("UserDetail")
                        .HasForeignKey("StoreOrder.WebApplication.Data.Models.Account.UserDetail", "UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
